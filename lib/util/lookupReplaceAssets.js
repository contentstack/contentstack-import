...
module.exports = function (data, mappedAssetUids, mappedAssetUrls, assetUidMapperPath) {
  ...
  if (matchedUids.length) {
    ...
    helper.writeFile(path.join(sanitizePath(assetUidMapperPath), 'matched-asset-uids.json'));
  }

  if (unmatchedUids.length) {
    var unmatchedAssetUids = helper.readFile(path.join(sanitizePath(assetUidMapperPath), 'unmatched-asset-uids.json'));
    ...
    helper.writeFile(path.join(sanitizePath(assetUidMapperPath), 'unmatched-asset-uids.json'));
  }

  if (unmatchedUrls.length) {
    var unmatchedAssetUrls = helper.readFile(path.join(sanitizePath(assetUidMapperPath), 'unmatched-asset-urls.json'));
    ...
    helper.writeFile(path.join(sanitizePath(assetUidMapperPath), 'unmatched-asset-urls.json'));
  }

  if (matchedUrls.length) {
    var matchedAssetUrls = helper.readFile(path.join(sanitizePath(assetUidMapperPath), 'matched-asset-urls.json'));
    ...
    helper.writeFile(path.join(sanitizePath(assetUidMapperPath), 'matched-asset-urls.json'));
  }
